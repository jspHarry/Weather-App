...
const App = () => {
  ...
  const API_KEY = '52823b9efe6d1f8a22ff448b9fcae3e3'
  ...
  const handleSearch = async (e) => {
    e.preventdDefault();
    if(!city.trim()) return setError("Please eneter a valid city name.");
  ...
  const getWeatherCondition = () => weather && ({
    ...
    idDay: Date.now() /1000 > weather.sys.sunrise && Date.now() / 1000 < weather.sys.sunset
  })
        ...
        <div className="bg-transparent backdrop:filter backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md text-white">
          <h1 className='text-4xl font-extrabold text-center mb-6'>
            ...
            {!weather ? (
              ...
              <div className="mt-6 text-center transtion-opacity duration-500">
